...
export default function SandboxPage() {
  return <><PageIntro label="Sandbox / Free play" title="Build anything. Test everything."><p>Walls, frogs, balloons. Set up your own battlefield and see what happens.</p><p>Supervision not provided.</p></PageIntro><PatternDivider /><section className="section sandbox-preview" aria-label="Sandbox battlefield"><ArtworkSlot asset={artwork.frogs} sizes="90vw" position="50% 55%" /><p className="caption">Float battlefield artwork / Free-form experimentation</p><Link className="text-link" href="/#modes">Explore all three modes ↗</Link></section><PatternDivider /><ReleaseCTA /></>;
}
