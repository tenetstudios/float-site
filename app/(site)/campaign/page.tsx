...
export default function CampaignPage() {
  return <><PageIntro label="Campaign" title="Your wall. Your frogs. Your enormous problem."><p>The free single-player campaign takes you from your first defense to a final encounter with something much, much bigger.</p></PageIntro><CampaignSection /><ReleaseCTA /></>;
}
