...
export default function MultiplayerPage() {
  return <><PageIntro label="Multiplayer" title="Outbuild. Outlaunch. Outthink."><p>A good defense is only half the argument. Bring your strategy to multiplayer and see how it holds up on both sides of the wall.</p></PageIntro><MultiplayerSection /><ReleaseCTA /></>;
}
